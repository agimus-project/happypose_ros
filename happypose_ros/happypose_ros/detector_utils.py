...
def aggregate_crop_detections(
    detections: DetectionsType, crop_bboxes: torch.Tensor, image_batch_size: int
):
    """
...
def get_multicrop_detections(
    detector,
    images: torch.Tensor,
    K: torch.Tensor,
    device,
    tile_detection_scale: float = 0.6,
    detector_args: dict = {},
):
    """
